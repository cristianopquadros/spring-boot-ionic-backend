...
CREATE TABLE `cliente` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cpfoucnpj` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `telefone` (
  ...
  `telefones` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2020-10-06 16:16:22
